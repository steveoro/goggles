...
=end
class DataImportTeamAnalysisResults < ActiveRecord::Base
  ...
  def to_s
    "[DataImportTeamAnalysisResults: data_import_session_id=#{data_import_session_id}, '#{searched_team_name}', season_id=#{desired_season_id} -" +
