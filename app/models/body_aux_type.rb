class BodyAuxType < ActiveRecord::Base
  ...
  def i18n_short
    I18n.t( "i18n_short_#{ self.code }".to_sym, {:scope=>[:body_aux_types]} )
  end

  # Computes a localized description for the value/code associated with this data
  def i18n_description
    I18n.t( "i18n_description_#{ self.code }".to_sym, {:scope=>[:body_aux_types]} )
  end
  # ----------------------------------------------------------------------------
