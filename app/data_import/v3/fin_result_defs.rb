...
class V3::FinResultDefs < V3::TxtResultDefs
  ...
  # This logger will be used by each V3::ContextDetector instance defined internally.
  attr_reader :logger
  # ----------------------------------------------------------------------------
  #++
  ...
  #
  # The logger specified here will be passed on to each V3::ContextDetector
  ...
  def initialize( logger = nil )
    ...
    @context_types = {                                # HEADER CONTEXT(s) def. arrays:
      meeting_header:   V3::ContextDetector.new( context_type_meeting_header, logger ),
      category_header:  V3::ContextDetector.new( context_type_category_header, logger ),
      relay_header:     V3::ContextDetector.new( context_type_relay_header, logger ),
      team_ranking:     V3::ContextDetector.new( context_type_team_ranking, logger ),

      team_stats:       V3::ContextDetector.new( context_type_team_stats, logger ),
      stats:            V3::ContextDetector.new( context_type_stats, logger ),
                                                      # DETAIL CONTEXT(s) def. arrays:
      result_row:       V3::ContextDetector.new( context_type_result_row, logger ),
      relay_row:        V3::ContextDetector.new( context_type_relay_row, logger ),
      ranking_row:      V3::ContextDetector.new( context_type_ranking_row, logger ),

      stats_details:    V3::ContextDetector.new( context_type_stats_details, logger )
    }
