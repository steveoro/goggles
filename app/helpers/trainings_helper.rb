...
module TrainingsHelper
  ...
  def link_to_training_show( training )
    link_to( training_path(id: training.id), class: 'btn btn-default' ) do
  ...
  def link_to_training_printout( training )
    link_to( training_printout_path(id: training.id), class: 'btn btn-default' ) do
  ...
  def link_to_training_edit( training )
    link_to( edit_training_path(id: training.id), class: 'btn btn-default' ) do
