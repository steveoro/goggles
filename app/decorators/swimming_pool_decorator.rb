...
= SwimmingPoolDecorator
  ...
  Contains all presentation-logic methods.
...
# TODO The following commented-out methods are already present in the core model. Althoug are surely
# presentation-centric, may as well reside with the model and be removed completely from
# this decorator:
