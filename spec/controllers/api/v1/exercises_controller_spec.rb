...
describe Api::V1::ExercisesController, type: :controller, api: true do
  before :each do
  ...
  describe '[GET exercises/index]' do
    context "with :code_like filtering parameter" do
      before :each do
        ...
        get :index, format: :json, params: { code_like: 'a1', user_email: @user.email, user_token: @user.authentication_token }
      end
    ...
    context "with :training_step_type_id filtering parameter" do
      before :each do
        ...
        get :index, format: :json, params: { training_step_type_id: 1, user_email: @user.email, user_token: @user.authentication_token }
      end
    ...
    context "with :description_like filtering parameter" do
      before :each do
        ...
        get :index, format: :json, params: { description_like: 'SL', user_email: @user.email, user_token: @user.authentication_token }
      end
