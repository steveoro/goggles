...
#
    # describe "#parse" do
      # it "recognizes a 'in progress' change of a multi-line context with a single correct feed" do
        ...
        # expect( subject.parse( V3::ContextDetector.new(dummy_wrapper.context_type_stats), 'Statistiche' ) ).to be true
      # end
    # end
    # #-- -----------------------------------------------------------------------
    # #++
#
    # context "after a successful context recognition," do
      # before(:each) do
        # subject.clear                               # Clear the service and do a quick parsing:
        # last_result = false
        # detector    = V3::ContextDetector.new( dummy_wrapper.context_type_stats )
