  ...
  context "[Standard Factory]" do
    ...
    describe "#rebuild_sql_text" do
      ...
      context "when it can insert a new Swimmer," do
        ...
        it "adds an 'INSERT INTO swimmers' statement in the #sql_text member" do
          expect( subject.sql_text ).to include( 'INSERT INTO swimmers' )
        end
      ...
      context "when it can insert a new Swimmer-Alias," do
        ...
        it "DOESN'T add an 'INSERT INTO swimmers' statement" do
          expect( subject.sql_text ).not_to include( 'INSERT INTO swimmers' )
        end
