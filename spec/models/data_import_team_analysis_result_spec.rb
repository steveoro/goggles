  ...
  context "[Standard Factory]" do
    ...
    describe "#rebuild_sql_text" do
      ...
      context "when it can insert a new Team," do
        ...
        it "adds an 'INSERT INTO teams' statement in the #sql_text member" do
          expect( subject.sql_text ).to include( 'INSERT INTO teams' )
        end
      ...
      context "when it can insert a new Team-Alias," do
        ...
        it "DOESN'T add an 'INSERT INTO teams' statement" do
          expect( subject.sql_text ).not_to include( 'INSERT INTO teams' )
        end
      ...
      context "when it can insert a new Team Affiliation," do
        ...
        it "adds an 'INSERT INTO team_affiliations' statement in the #sql_text member" do
          expect( subject.sql_text ).to include( 'INSERT INTO team_affiliations' )
        end
      end
    end
  end
