...
describe "FinResultParser parsing fixture file 4,", type: :integration do
  FIXTURE_FILE_4 = File.join(Rails.root, 'test/fixtures/samples/fixture4-ris20121112bologna-sample.txt')

  # We need to parse the fixture file just once to speed-up tests:
  before( :all ) { @result_hash = FinResultParser.parse_txt_file( FIXTURE_FILE_4 ) }
