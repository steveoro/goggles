...
describe EnhanceIndividualRankingDAO, type: :model do
  ...
  context "EIRMeetingScoreDAO subclass," do
    ...
    it_behaves_like( "(the existance of a method)", [
      :header_date, :event_bonus_points, :medal_bonus_points, :event_points,
      :performance_points, :enhance_points, :event_results, :get_total_points
    ] )
...
# FIXME This yields random failures @line 181: subject.performance_points = 104
    describe "#performance_points" do
      it "is a value between 0 and 100" do
        expect( subject.performance_points ).to be >= 0
