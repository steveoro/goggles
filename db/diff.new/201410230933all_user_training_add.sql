...
DELETE FROM user_training_rows WHERE user_training_id = (select t.id from user_trainings t where t.description = 'MC1 Set 06.4 andature serali by Tino');
DELETE FROM user_training_stories WHERE user_training_id = (select t.id from user_trainings t where t.description = 'MC1 Set 06.4 andature serali by Tino');
DELETE FROM user_trainings WHERE description = 'MC1 Set 06.4 andature serali by Tino';
...
('MC1 Set 06.4 andature serali by Tino',2,0,CURDATE(),CURDATE());
...
('2014-10-17',2880,'Incoraggiante',(select t.id from user_trainings t where t.description = 'MC1 Set 06.4 andature serali by Tino'),(select t.id from swimming_pools t where t.nick_name = 'reggiocomunale50'),(select t.id from swimmer_level_types t where t.code = 'MX'),2,0,CURDATE(),CURDATE());
