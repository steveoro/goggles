...
INSERT INTO `data_import_team_aliases` (`id`, `created_at`, `updated_at`, `name`, `team_id`)
  VALUES (54, '2015-02-16 11:41:03', '2015-02-16 11:41:03', 'A.R.C.A. SSD. RL', 138);


-- Processing:...'ACQUA TIME SSD':
-- aliased with: 'ACQUA TIME' (ID:6)
INSERT INTO `data_import_team_aliases` (`id`, `created_at`, `updated_at`, `name`, `team_id`)
  VALUES (55, '2015-02-16 11:41:03', '2015-02-16 11:41:03', 'ACQUA TIME SSD', 6);


-- Processing:...'ACQUAMBIENTE SSD -':
-- aliased with: 'ACQUAMBIENTE SRL SSD' (ID:151)
INSERT INTO `data_import_team_aliases` (`id`, `created_at`, `updated_at`, `name`, `team_id`)
  VALUES (56, '2015-02-16 11:41:03', '2015-02-16 11:41:03', 'ACQUAMBIENTE SSD -', 151);
...
INSERT INTO `data_import_team_aliases` (`id`, `created_at`, `updated_at`, `name`, `team_id`)
  VALUES (57, '2015-02-16 11:41:05', '2015-02-16 11:41:05', 'AS.D.VILLAGGIO FANCIULLO', 25);
...
INSERT INTO `data_import_team_aliases` (`id`, `created_at`, `updated_at`, `name`, `team_id`)
  VALUES (58, '2015-02-16 11:41:08', '2015-02-16 11:41:08', 'H. SPORT SSD - PRAT', 16);
...
INSERT INTO `data_import_team_aliases` (`id`, `created_at`, `updated_at`, `name`, `team_id`)
  VALUES (59, '2015-02-16 11:41:08', '2015-02-16 11:41:08', 'MONTENUOTO S.S.D RL', 161);
...
INSERT INTO `data_import_team_aliases` (`id`, `created_at`, `updated_at`, `name`, `team_id`)
  VALUES (60, '2015-02-16 11:41:10', '2015-02-16 11:41:10', 'RIVIERA NUOTO VENET', 175);


-- Processing:...'SAVENA NUOTO TEAM A':
-- aliased with: 'SAVENA NUOTO' (ID:11)
INSERT INTO `data_import_team_aliases` (`id`, `created_at`, `updated_at`, `name`, `team_id`)
  VALUES (61, '2015-02-16 11:41:10', '2015-02-16 11:41:10', 'SAVENA NUOTO TEAM A', 11);
...
INSERT INTO `data_import_team_aliases` (`id`, `created_at`, `updated_at`, `name`, `team_id`)
  VALUES (62, '2015-02-16 11:41:10', '2015-02-16 11:41:10', 'TEAM EUGANEO', 176);
...
INSERT INTO `data_import_swimmer_aliases` (`id`, `created_at`, `updated_at`, `complete_name`, `swimmer_id`)
  VALUES (5, '2015-02-16 11:44:48', '2015-02-16 11:44:48', 'BACCILIERI ANNA', 1526);
...
INSERT INTO `data_import_swimmer_aliases` (`id`, `created_at`, `updated_at`, `complete_name`, `swimmer_id`)
  VALUES (6, '2015-02-16 11:44:50', '2015-02-16 11:44:50', 'CANTELLO ENTONI', 1703);
...
INSERT INTO `data_import_swimmer_aliases` (`id`, `created_at`, `updated_at`, `complete_name`, `swimmer_id`)
  VALUES (7, '2015-02-16 11:44:50', '2015-02-16 11:44:50', 'CARPANELLI SARA', 1706);
...
INSERT INTO `data_import_swimmer_aliases` (`id`, `created_at`, `updated_at`, `complete_name`, `swimmer_id`)
  VALUES (8, '2015-02-16 11:44:50', '2015-02-16 11:44:50', 'DALL`OLIO ELENA', 300);
...
INSERT INTO `data_import_swimmer_aliases` (`id`, `created_at`, `updated_at`, `complete_name`, `swimmer_id`)
  VALUES (9, '2015-02-16 11:44:52', '2015-02-16 11:44:52', 'RIOS FIDEL MARCIAL', 111);
...
INSERT INTO `data_import_swimmer_aliases` (`id`, `created_at`, `updated_at`, `complete_name`, `swimmer_id`)
  VALUES (10, '2015-02-16 11:44:52', '2015-02-16 11:44:52', 'THOMPSON JOHN MICHEAL', 2428);


-- Processing:...'TIPOLONE FABIO' (1985, gender: 1)
-- aliased with: 'TRIPOLONE FABIO' (ID:2517)
INSERT INTO `data_import_swimmer_aliases` (`id`, `created_at`, `updated_at`, `complete_name`, `swimmer_id`)
  VALUES (11, '2015-02-16 11:44:52', '2015-02-16 11:44:52', 'TIPOLONE FABIO', 2517);


-- Processing:...'TUGNOLI GIAMPAOLO' (1963, gender: 1)
-- aliased with: 'TUGNOLI GIANPAOLO' (ID:747)
INSERT INTO `data_import_swimmer_aliases` (`id`, `created_at`, `updated_at`, `complete_name`, `swimmer_id`)
  VALUES (12, '2015-02-16 11:44:52', '2015-02-16 11:44:52', 'TUGNOLI GIAMPAOLO', 747);
