...
= DataImportMeetingProgramBuilder
  ...
  - Goggles framework vers.:  4.00.553
  - author: Steve A.
...
#        @phase_1_log << "begin_time=#{@begin_time}\r\n"
        ...
        ).first if meeting_session.instance_of?(MeetingSession) && @event_type
        ...
        @time_standard = DataImportTimeStandardBuilder.build_from_parameters(
          ...
          @secs,
          @hds
        ).result_row if @event_type && ( @mins.to_i > 0 || @secs.to_i > 0 || @hds.to_i > 0 )
...
# FIXME @event_type.nil? SHOULD NEVER OCCUR:
...
# FIXME @event_type.nil? SHOULD NEVER OCCUR:
          ...
          seconds:                        @secs,
          hundreds:                       @hds,
          # FIXME This is not parsed at all:
...
# FIXME Also @time_standard.nil? SHOULD NEVER OCCUR:
          time_standard_id:               @time_standard.id,
